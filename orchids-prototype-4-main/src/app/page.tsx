        ...
        <div className="flex items-center gap-5">
          <SignedOut>
            <div className="flex items-center gap-4">
              <SignInButton mode="modal">
                <button className="text-[11px] font-semibold uppercase tracking-[0.15em] text-white/30 hover:text-white transition-all">
                  Sign In
                </button>
              </SignInButton>
              <SignUpButton mode="modal">
                <button className="group relative flex items-center justify-center overflow-hidden rounded-full bg-white px-7 py-2.5 text-xs font-bold text-black transition-all hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_20px_rgba(255,255,255,0.1)]">
          ...
          <SignedIn>
            <div className="flex items-center gap-4">
              <Link
                href="/editor"
                className="group relative flex items-center justify-center overflow-hidden rounded-full bg-white/5 border border-white/10 px-6 py-2 text-xs font-bold text-white transition-all hover:bg-white/10 hover:scale-[1.02] active:scale-[0.98]"
              >
